...
T["setup()"]["sets exposed methods and default options value"] = function()
  child.lua [[require('explain-it').setup()]]

  -- global object that holds your plugin information
  eq_type_global(child, "_G.ExplainIt", "table")

  -- public methods
  eq_type_global(child, "_G.ExplainIt.toggle", "function")
  eq_type_global(child, "_G.ExplainIt.disable", "function")
  eq_type_global(child, "_G.ExplainIt.enable", "function")

  -- config
  eq_type_global(child, "_G.ExplainIt.config", "table")
