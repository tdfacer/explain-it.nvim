...
-- @usage global_equality(child, "_G.ExplainItLoaded", true)
...
-- @usage global_type_equality(child, "_G.ExplainItLoaded", "boolean")
...
Helpers.expect.config_equality = MiniTest.new_expectation(
  ...
  function(child, field, value)
    return Helpers.expect.global_equality(child, "_G.ExplainIt.config." .. field, value)
  end,
  errorMessage
)
...
Helpers.expect.config_type_equality = MiniTest.new_expectation(
  ...
  function(child, field, value)
    return Helpers.expect.global_equality(child, "type(_G.ExplainIt.config." .. field .. ")", value)
  end,
  errorMessage
)
...
Helpers.expect.state_equality = MiniTest.new_expectation(
  "state matches",
  function(child, field, value)
    return Helpers.expect.global_equality(child, "_G.ExplainIt.enabled." .. field, value)
  end,
  errorMessage
)
...
Helpers.expect.state_type_equality = MiniTest.new_expectation(
  "state type matches",
  function(child, field, value)
    return Helpers.expect.global_equality(child, "type(_G.ExplainIt.state." .. field .. ")", value)
  end,
  errorMessage
)
