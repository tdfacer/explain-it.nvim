...
M.notify_response = function(ai_response)
  if not ai_response then return nil end
  ...
  local question = should_split and strings.truncate_string(ai_response.question, width) or ai_response.question
  local input = should_split and strings.truncate_string(ai_response.input, width) or ai_response.input
  local response = should_split and strings.format_string_with_line_breaks(ai_response.response) or ai_response.response
