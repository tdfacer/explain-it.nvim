...
M.options = {
  ...
  max_retries = 3,
  -- API provider to send requests to: "openai" or "anthropic"
  provider = "openai",
  ...
  -- Anthropic (Claude) settings, used when provider = "anthropic". Reads the key from ANTHROPIC_API_KEY.
  anthropic_base_api = "https://api.anthropic.com/v1",
  anthropic_model = "claude-opus-5",
  anthropic_max_tokens = 16000,
  -- If Claude's safety classifiers decline a request, re-run it on Anthropic's recommended
  -- fallback model. Set to false to disable.
