...
---@param opts table Optional parameters
---@return AIResponse
M.call_gpt = function(escaped_input, optional_question, prompt_type, opts)
  D.log(
  ...
  local formatted_prompt = M.get_formatted_command(escaped_input, question, prompt_type, opts)
