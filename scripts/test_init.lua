...
vim.keymap.set("n", "<space>Z", function() require("explain-it").explain_it { custom_prompt = true } end, opts)
-- vim.keymap.set("v", "<space>Z", function() require"explain-it".explain_it_visual({custom_prompt = true}) end, opts)
vim.keymap.set(
  "v",
  "<space>Z",
  function() require("explain-it").explain_it { custom_prompt = true, is_visual = true } end,
  opts
)
vim.keymap.set(
  "n",
  "<space>x",
  function() require("explain-it").explain_it { custom_prompt = false, api_type = "chat" } end,
  opts
)
vim.keymap.set(
  "v",
  "<space>x",
  function() require("explain-it").explain_it { custom_prompt = false, api_type = "chat", is_visual = true } end,
  opts
)
vim.keymap.set(
  "n",
  "<space>X",
  function() require("explain-it").explain_it { custom_prompt = true, api_type = "chat" } end,
  opts
)
vim.keymap.set(
  "v",
  "<space>X",
  function() require("explain-it").explain_it { custom_prompt = true, api_type = "chat", is_visual = true } end,
  opts
)
